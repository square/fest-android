...
public class TelephonyManagerAssert extends AbstractAssert<TelephonyManagerAssert, TelephonyManager> {
  ...
  public TelephonyManagerAssert hasCallState(@TelephonyManagerCallState int state) {
    ...
    assertThat(actualState) //
        .overridingErrorMessage("Expected call state <%s> but was <%s>.",
            callStateToString(state), callStateToString(actualState)) //
        .isEqualTo(state);
    return this;
  }
  ...
  public TelephonyManagerAssert hasCellLocation(CellLocation cellLocation) {
    ...
    assertThat(actualCellLocation) //
        .overridingErrorMessage("Expected cell location <%s> but was <%s>.", cellLocation, actualCellLocation) //
  ...
  public TelephonyManagerAssert hasDeviceId(String deviceId) {
    ...
    assertThat(actualDeviceId) //
        .overridingErrorMessage("Expected device ID <%s> but was <%s>.", deviceId, actualDeviceId) //
        .isEqualTo(deviceId);
    return this;
  }
  ...
  public TelephonyManagerAssert hasDeviceSoftwareVersion(String version) {
    ...
    assertThat(actualVersion) //
        .overridingErrorMessage("Expected device software version <%s> but was <%s>.", version, actualVersion) //
        .isEqualTo(version);
    return this;
  }
  ...
  public TelephonyManagerAssert hasGroupIdLevel1(String level) {
    ...
    assertThat(actualLevel) //
        .overridingErrorMessage("Expected group ID level 1 <%s> but was <%s>.", level, actualLevel) //
        .isEqualTo(level);
    return this;
  }
  ...
  public TelephonyManagerAssert hasLine1Number(String number) {
    ...
    assertThat(actualNumber) //
        .overridingErrorMessage("Expected line 1 number <%s> but was <%s>.", number, actualNumber) //
        .isEqualTo(number);
    return this;
  }
  ...
  public TelephonyManagerAssert hasMmsUAProfUrl(String url) {
    ...
    assertThat(actualUrl) //
        .overridingErrorMessage("Expected MMS user agent profile URL <%s> but was <%s>.", url, actualUrl) //
        .isEqualTo(url);
    return this;
  }
  ...
  public TelephonyManagerAssert hasMmsUserAgent(String userAgent) {
    ...
    assertThat(actualUserAgent) //
        .overridingErrorMessage("Expected MMS user agent <%s> but was <%s>.", userAgent, actualUserAgent) //
        .isEqualTo(userAgent);
    return this;
  }
  ...
  public TelephonyManagerAssert hasNetworkCountryIso(String iso) {
    ...
    assertThat(actualIso) //
        .overridingErrorMessage("Expected network country ISO <%s> but was <%s>.", iso, actualIso) //
        .isEqualTo(iso);
    return this;
  }
  ...
  public TelephonyManagerAssert hasNetworkOperator(String operator) {
    ...
    assertThat(actualOperator) //
        .overridingErrorMessage("Expected network operator <%s> but was <%s>.", operator, actualOperator) //
        .isEqualTo(operator);
    return this;
  }
  ...
  public TelephonyManagerAssert hasNetworkOperatorName(String name) {
    ...
    assertThat(actualName) //
        .overridingErrorMessage("Expected network operator name <%s> but was <%s>.", name, actualName) //
        .isEqualTo(name);
    return this;
  }
  ...
  public TelephonyManagerAssert hasPhoneType(@TelephonyManagerPhoneType int type) {
    ...
    //noinspection ResourceType
    assertThat(actualType) //
        .overridingErrorMessage("Expected phone type <%s> but was <%s>.",
            phoneTypeToString(type), phoneTypeToString(actualType)) //
        .isEqualTo(type);
    return this;
  }
  ...
  public TelephonyManagerAssert hasSimOperator(String operator) {
    ...
    assertThat(actualOperator) //
        .overridingErrorMessage("Expected SIM operator <%s> but was <%s>.", operator, actualOperator) //
        .isEqualTo(operator);
    return this;
  }
  ...
  public TelephonyManagerAssert hasSimOperatorName(String name) {
    ...
    assertThat(actualName) //
        .overridingErrorMessage("Expected SIM operator name <%s> but was <%s>.", name, actualName) //
        .isEqualTo(name);
    return this;
  }
  ...
  public TelephonyManagerAssert hasSimSerialNumber(String serialNumber) {
    ...
    assertThat(actualSerialNumber) //
        .overridingErrorMessage("Expected SIM serial number <%s> but was <%s>.", serialNumber, actualSerialNumber) //
  ...
  public TelephonyManagerAssert hasSimState(@TelephonyManagerSimState int state) {
    ...
    //noinspection ResourceType
    assertThat(actualState) //
        .overridingErrorMessage("Expected SIM state <%s> but was <%s>.",
            simStateToString(state), simStateToString(actualState)) //
        .isEqualTo(state);
    return this;
  }
  ...
  public TelephonyManagerAssert hasVoiceMailAlphaTag(String tag) {
    ...
    assertThat(actualTag) //
        .overridingErrorMessage("Expected voice mail alpha tag <%s> but was <%s>.", tag, actualTag) //
        .isEqualTo(tag);
    return this;
  }
  ...
  public TelephonyManagerAssert hasVoiceMailNumber(String number) {
    ...
    assertThat(actualNumber) //
        .overridingErrorMessage("Expected voice mail number <%s> but was <%s>.", number, actualNumber) //
        .isEqualTo(number);
    return this;
  }
